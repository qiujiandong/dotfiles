...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/jdqiu/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/jdqiu"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/jdqiu/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/jdqiu/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/jdqiu/.tmux/plugins//tmux-continuum"
# }
...
# tmux_mem_cpu_load.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="-g 10 -a 0"
# }
...
# weather.sh {
	...
	#   rm "/tmp/tmux-powerline_jdqiu/tmux-powerline/weather_cache_data.txt"
